...
void main() {
  test('extracts source-linked text geometry and index chunks from a PDF', () async {
    ...
    try {
      ...
      expect(
        page.fragments.map(page.textFor).join(),
        contains('Hello Kola'),
      );
      ...
      expect(graphChunks.single.nodes.single.kind, KolaNodeKind.sourceVisualBlock);
